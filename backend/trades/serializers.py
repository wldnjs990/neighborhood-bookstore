...
from accounts.serializers import UserSerializer  # 이미 만들어진 UserSerializer
from books.serializers import BookPreviewSerializer # 도서 요약 정보용
...
class TradeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'image', 'kakao_chat_url', 'view_count', 'created_at'
        ]
...
class TradeDetailSerializer(serializers.ModelSerializer):
    ...
    book = BookPreviewSerializer(read_only=True)

    # book -> price_standard, adult, title, category

    # user id, nickname만 뻬오기
    class Meta:
        model = Trade
